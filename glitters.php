...
if (count($_POST) > 0) {
  if ($_POST['Submit'] == 'Send Message') {
    ...
    if (strlen($name) > 0 && strlen($email) > 0) {
      ...
      $headers = "From: Glitters@learnthedigital.com" . "\r\n" .
        "";
      $msg = "Glitters -$name";
...
<title>Glitters | Learn The Digital</title>
<style>
  .about_button {
...
<head>
  ...
  <!-- Favicons -->
  <link href="GILITERS/Glitters logo.png" rel="icon">
  <link href="GILITERS/Glitters logo.png" rel="apple-touch-icon">
   ...
   <div class="row">
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" style="margin-top:10%"
            class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" style="color:#8f1393">Enquire Now</h4>
                         <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                      </div>
                      <div class="modal-body">
                      <img src="GILITERS\glitters6382.png" width="350px">
              ...
              <div class="text-center" ><button type="submit" name='Submit' value='Send Message' style="border:0px;background-color:#8f1393;padding:10px 24px;color:#fff;transition:0.4s;border-radius:4px;">Get a Call Back</button></div>
            </form>
                      </div>
                    </div>
                  </div>
  ...
  <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <img src="GILITERS/Glitters logo.png" width="150px">
          <h2>For All Types of</h2>
          <h3 Style="color:#8f1393">Rooms & Banquet Hall at Resonable Prices</h3>
          <p>Catering and Decoration Charges as per actuals</p>
          <p>Sogoni Kala Raisen Road, Near Reshamraa Hotel, Bhopal - 462022</p>
          <p><a href="tel:+919876543221" Style="color:#8f1393">+91 98765 43221</a></p>
         </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <img src="GILITERS\G_img_0003.jpeg" width="380px">
          ...
          <div class="col-lg-6">
            <form action="contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <textarea class="form-control" name="message" rows="5" placeholder="Type your query here" required></textarea>
              </div>
              <div class="text-center" onclick="myFunction()"><button type="submit" style="border:0px;background-color:#8f1393;padding:10px 24px;color:#fff;transition:0.4s;border-radius:4px;">Get a Call Back</button></div>
            </form>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box" data-aos="fade-up" data-aos-delay="100">
              <h3 Style="color:#8f1393">Receptions</h3>
              <img src="GILITERS\RECEPTION.png" width="300px">
              <div class="btn-wrap">
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box" data-aos="fade-up" data-aos-delay="100">
              <h3 Style="color:#8f1393">PARTIES</h3>
              <img src="GILITERS\PARTIES.png" width="300px">
              <div class="btn-wrap">
                <!-- <a href="#" class="btn-buy">Buy Now</a>-->
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box" data-aos="fade-up" data-aos-delay="100">
              <h3 Style="color:#8f1393">Weddings</h3>
              <img src="GILITERS\WEDDINGS.png" width="300px">
              <div class="btn-wrap">
                <!-- <a href="#" class="btn-buy">Buy Now</a>-->
              </div>
            </div>
    ...
    <section id="team" class="team section-bg">
      ...
      <div class="section-title">
         <img src="GILITERS\Swastik.png" width="150px">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="GILITERS\standard_room.png" class="img-fluid" alt="unlimited fashion store logo">               
               </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="GILITERS\standard_room.png" class="img-fluid" alt="BNC Traders logo">
                </div>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        ...
        <div class="credits">
          Designed by <a href="#" Style="color:white">Learn The Digital Development</a>
        </div>
      </div>
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        <a Style="background-color:white;color:black" href="https://www.facebook.com/RehabiliationCentre" class="facebook">
          <iconify-icon data-icon="bx-bxl-facebook"></iconify-icon>
        </a>
        <a Style="background-color:white;color:black;" href="https://wa.me/+919619938447" class="linkedin">
          <iconify-icon data-icon="akar-icons:whatsapp-fill"></iconify-icon>
        </a>
        <a Style="background-color:white;color:black;" href="https://www.google.com/maps/place/Shifa+Dental+Care/@18.9638282,72.8186525,17z/data=!3m1!4b1!4m5!3m4!1s0x3be7cf1254ba5d29:0x214b73fa639b52be!8m2!3d18.9638282!4d72.8208412" class="google">
          <iconify-icon data-icon="bx-bxl-google"></iconify-icon>
        </a>
      </div>
    </div>
  </footer><!-- End Footer -->
  <a href="https://wa.me/+919876543221" class="back-to-top-whatsapp" style="position: fixed;display:inline;width: 40px;height: 40px;border-radius: 3px;right: 15px;bottom: 60px;background: #25D366;color: #fff;transition: display 0.5s ease-in-out;z-index: 99999;"><i class="icofont-brand-whatsapp" style="font-size: 24px;position: absolute;top: 8px;left: 8px;"></i></a>
  <a href="#" class="back-to-top" Style="background-color:white;color:black;"><i class="icofont-simple-up"></i></a>
